<div class="social-shareable-widget">
...
@vite([
    'resources/vendor/social-shareable/assets/shareable-widget.js',
    'resources/vendor/social-shareable/assets/shareable-widget.css',
])
